...
$recorderContent = Get-Content "$ProjectRoot\frontend\src\audio\recorder.ts" -Raw
...
$managerContent = Get-Content "$ProjectRoot\frontend\src\services\managers\RecordingManager.ts" -Raw
...
$appContent = Get-Content "$ProjectRoot\frontend\src\App.tsx" -Raw
...
$adapterContent = Get-Content "$ProjectRoot\backend\sherpa_adapter\adapter.py" -Raw
