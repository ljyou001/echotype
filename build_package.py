...
Automatically merges the dist directories of the three components into a unified release package.
"""
...
def def merge_dist_folders():
    """Merges the three dist directories into a unified release package."""
    ...
    # Dist directories of the three components
    ...
    # 1. Copy all contents of EchoType as the base
        ...
        for item in server_internal.iterdir():
            ...
            if item.is_file():
                ...
                if not dest.exists():
                    ...
                    # If the directory exists, merge its contents
